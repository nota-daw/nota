...
<section id="cards">
  ...
  <p class="note">Width exceptions by decision: Rhythm 900, Bass 1060, Physical 720, and the plugin / parameter-list stubs.</p>
</section>
...
<section id="shell">
  ...
  <ul class="plain">
    ...
    <li>Rhythm, Bass and Physical cards are wider than 700.</li>
