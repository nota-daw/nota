...
public sealed class FactoryPresetCatalog : IFactoryPresets
{
    ...
    public FactoryPresetCatalog()
    {
        ...
        // ---- Nota Pendulum (kind 8) — generative keys, 28 patches. Balls 0 2 … 1 6 (quarter
        //      steps); Sync Free 0 / Sync 1; Division 0 1/1 · .25 1/2 · .5 1/4 · .75 1/8 · 1 1/16;
        //      Rate 0.5 = stop, <0.5 reverse; Motion 0 Linear/.33 Pendulum/.67 Ease/1 Bounce;
        //      Quantize 0 Off/.5 1/16/1 1/8; Chord Sort Up 0 / Down 1; Wave 0 Keys/.25 Glass/
        //      .5 Saw/.75 Sqr/1 Bell; Scale Mode 0 Off/.2 Major/.4 Minor/.6 Dorian/.8 Mixolydian/
        //      1 Minor penta, Root = semitone/11.
        ...
        Inst("pendulum", 8, "Music Box",         ("balls", 0.4f), ("rate", 0.7f), ("sync", 1f), ("division", 0.5f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.15f), ("notelen", 0.2f), ("tone", 0.75f), ("attack", 0.02f), ("decay", 0.3f), ("release", 0.5f), ("detune", 0.12f), ("wave", 0.25f), ("bright", 0.75f), ("fm", 0.1f), ("panspread", 0.5f), ("humanize", 0.1f), ("volume", 0.78f));
        Inst("pendulum", 8, "Bell Garden",       ("balls", 0.75f), ("rate", 0.66f), ("sync", 1f), ("division", 0.25f), ("motion", 0.67f), ("quantize", 0.5f), ("spread", 0.35f), ("notelen", 0.35f), ("tone", 0.6f), ("attack", 0.05f), ("decay", 0.55f), ("release", 0.7f), ("detune", 0.2f), ("wave", 1f), ("bright", 0.55f), ("fm", 0.2f), ("panspread", 0.65f), ("humanize", 0.2f), ("scalemode", 0.2f), ("volume", 0.76f));
        Inst("pendulum", 8, "Pentatonic Rain",   ("balls", 1f), ("rate", 0.78f), ("sync", 1f), ("division", 0.5f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.45f), ("notelen", 0.25f), ("tone", 0.55f), ("attack", 0.03f), ("decay", 0.35f), ("release", 0.45f), ("detune", 0.25f), ("wave", 0.25f), ("bright", 0.6f), ("panspread", 0.8f), ("humanize", 0.3f), ("scalemode", 1f), ("root", 9f / 11f), ("volume", 0.76f));
        Inst("pendulum", 8, "Dorian Drift",      ("balls", 0.5f), ("rate", 0.6f), ("sync", 0f), ("freerate", 0.6f), ("motion", 0.33f), ("quantize", 0f), ("spread", 0.5f), ("notelen", 0.6f), ("tone", 0.4f), ("attack", 0.25f), ("decay", 0.6f), ("release", 0.8f), ("detune", 0.4f), ("bright", 0.35f), ("panspread", 0.5f), ("humanize", 0.3f), ("scalemode", 0.6f), ("root", 2f / 11f), ("volume", 0.8f));
        Inst("pendulum", 8, "Hold Pad",          ("balls", 0.5f), ("rate", 0.58f), ("sync", 0f), ("freerate", 0.8f), ("motion", 0.67f), ("quantize", 0f), ("spread", 0.3f), ("notelen", 1f), ("tone", 0.38f), ("attack", 0.6f), ("decay", 0.8f), ("release", 0.85f), ("detune", 0.5f), ("bright", 0.25f), ("panspread", 0.6f), ("humanize", 0.15f), ("hold", 1f), ("volume", 0.74f));
        Inst("pendulum", 8, "Saw Arp",           ("balls", 0.25f), ("rate", 0.8f), ("sync", 1f), ("division", 0.75f), ("motion", 0f), ("quantize", 0.5f), ("spread", 0f), ("notelen", 0.2f), ("tone", 0.55f), ("attack", 0.01f), ("decay", 0.3f), ("release", 0.25f), ("detune", 0.35f), ("wave", 0.5f), ("bright", 0.5f), ("panspread", 0.2f), ("humanize", 0f), ("volume", 0.7f));
        Inst("pendulum", 8, "Square Steps",      ("balls", 0.25f), ("rate", 0.75f), ("sync", 1f), ("division", 0.5f), ("motion", 0f), ("quantize", 1f), ("spread", 0.1f), ("notelen", 0.25f), ("tone", 0.5f), ("attack", 0.02f), ("decay", 0.3f), ("release", 0.3f), ("detune", 0.25f), ("wave", 0.75f), ("bright", 0.45f), ("panspread", 0.3f), ("humanize", 0.05f), ("volume", 0.72f));
        Inst("pendulum", 8, "FM Glints",         ("balls", 0.75f), ("rate", 0.82f), ("sync", 1f), ("division", 0.5f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.25f), ("notelen", 0.15f), ("tone", 0.7f), ("attack", 0.01f), ("decay", 0.25f), ("release", 0.35f), ("detune", 0.15f), ("bright", 0.6f), ("fm", 0.55f), ("panspread", 0.55f), ("humanize", 0.15f), ("volume", 0.76f));
        Inst("pendulum", 8, "Two Clocks",        ("balls", 0f), ("rate", 0.7f), ("sync", 1f), ("division", 0.25f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 1f), ("notelen", 0.35f), ("tone", 0.45f), ("attack", 0.08f), ("decay", 0.45f), ("release", 0.5f), ("detune", 0.3f), ("panspread", 0.9f), ("humanize", 0.1f), ("volume", 0.82f));
        Inst("pendulum", 8, "Six Pendulums",     ("balls", 1f), ("rate", 0.64f), ("sync", 1f), ("division", 0f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.55f), ("notelen", 0.4f), ("tone", 0.45f), ("attack", 0.1f), ("decay", 0.5f), ("release", 0.55f), ("detune", 0.3f), ("panspread", 0.7f), ("humanize", 0.2f), ("volume", 0.74f));
        Inst("pendulum", 8, "Rewind",            ("balls", 0.5f), ("rate", 0.2f), ("sync", 1f), ("division", 0.5f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.3f), ("notelen", 0.3f), ("tone", 0.5f), ("attack", 0.05f), ("decay", 0.4f), ("release", 0.45f), ("detune", 0.25f), ("wave", 0.25f), ("bright", 0.55f), ("panspread", 0.45f), ("humanize", 0.15f), ("volume", 0.78f));
        Inst("pendulum", 8, "Linear Ladder",     ("balls", 0.5f), ("rate", 0.76f), ("sync", 1f), ("division", 0.25f), ("motion", 0f), ("quantize", 0.5f), ("spread", 0f), ("notelen", 0.3f), ("tone", 0.5f), ("attack", 0.03f), ("decay", 0.35f), ("release", 0.35f), ("detune", 0.2f), ("panspread", 0.3f), ("humanize", 0f), ("volume", 0.8f));
        Inst("pendulum", 8, "Rubber Bounce",     ("balls", 0.5f), ("rate", 0.74f), ("sync", 1f), ("division", 0.25f), ("motion", 1f), ("quantize", 0f), ("spread", 0.2f), ("notelen", 0.25f), ("tone", 0.45f), ("attack", 0.02f), ("decay", 0.4f), ("release", 0.35f), ("detune", 0.25f), ("wave", 0.75f), ("bright", 0.35f), ("fm", 0.1f), ("panspread", 0.4f), ("humanize", 0.25f), ("volume", 0.76f));
        Inst("pendulum", 8, "Free Chimes",       ("balls", 0.75f), ("rate", 0.7f), ("sync", 0f), ("freerate", 0.35f), ("motion", 0.67f), ("quantize", 0f), ("spread", 0.6f), ("notelen", 0.3f), ("tone", 0.7f), ("attack", 0.01f), ("decay", 0.6f), ("release", 0.9f), ("detune", 0.1f), ("wave", 1f), ("bright", 0.7f), ("fm", 0.15f), ("panspread", 0.85f), ("humanize", 0.35f), ("volume", 0.72f));
        Inst("pendulum", 8, "Lullaby",           ("balls", 0.25f), ("rate", 0.6f), ("sync", 1f), ("division", 0.25f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.1f), ("notelen", 0.55f), ("tone", 0.3f), ("attack", 0.3f), ("decay", 0.6f), ("release", 0.75f), ("detune", 0.35f), ("bright", 0.2f), ("panspread", 0.3f), ("humanize", 0.15f), ("scalemode", 0.2f), ("volume", 0.82f));
        Inst("pendulum", 8, "Minor Cascade",     ("balls", 0.75f), ("rate", 0.74f), ("sync", 1f), ("division", 0.5f), ("motion", 0.67f), ("quantize", 0.5f), ("spread", 0.3f), ("notelen", 0.35f), ("tone", 0.45f), ("attack", 0.06f), ("decay", 0.45f), ("release", 0.55f), ("detune", 0.3f), ("bright", 0.45f), ("panspread", 0.5f), ("humanize", 0.2f), ("scalemode", 0.4f), ("volume", 0.78f));
        Inst("pendulum", 8, "Eighth Machine",    ("balls", 0.5f), ("rate", 0.85f), ("sync", 1f), ("division", 0.75f), ("motion", 0f), ("quantize", 0.5f), ("spread", 0f), ("notelen", 0.12f), ("tone", 0.6f), ("attack", 0.005f), ("decay", 0.2f), ("release", 0.15f), ("detune", 0.2f), ("wave", 0.5f), ("bright", 0.6f), ("panspread", 0.25f), ("humanize", 0f), ("volume", 0.7f));
        Inst("pendulum", 8, "Mixolydian Sun",    ("balls", 0.75f), ("rate", 0.7f), ("sync", 1f), ("division", 0.5f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.4f), ("notelen", 0.3f), ("tone", 0.65f), ("attack", 0.03f), ("decay", 0.35f), ("release", 0.45f), ("detune", 0.2f), ("wave", 0.25f), ("bright", 0.65f), ("panspread", 0.6f), ("humanize", 0.2f), ("scalemode", 0.8f), ("root", 7f / 11f), ("volume", 0.76f));
        Inst("pendulum", 8, "Deep Keys",         ("balls", 0.5f), ("rate", 0.66f), ("sync", 1f), ("division", 0.25f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.2f), ("notelen", 0.5f), ("tone", 0.22f), ("attack", 0.12f), ("decay", 0.55f), ("release", 0.6f), ("detune", 0.45f), ("bright", 0.15f), ("panspread", 0.3f), ("humanize", 0.15f), ("volume", 0.85f));
        Inst("pendulum", 8, "Wide Shimmer",      ("balls", 1f), ("rate", 0.72f), ("sync", 1f), ("division", 0.5f), ("motion", 0.67f), ("quantize", 0.5f), ("spread", 0.5f), ("notelen", 0.2f), ("tone", 0.8f), ("attack", 0.02f), ("decay", 0.3f), ("release", 0.6f), ("detune", 0.6f), ("wave", 0.25f), ("bright", 0.85f), ("fm", 0.2f), ("panspread", 1f), ("humanize", 0.3f), ("volume", 0.72f));
        Inst("pendulum", 8, "Restart Motif",     ("balls", 0.25f), ("rate", 0.75f), ("sync", 1f), ("division", 0.25f), ("motion", 0.33f), ("quantize", 0.5f), ("spread", 0.25f), ("firstnote", 1f), ("notelen", 0.35f), ("tone", 0.5f), ("attack", 0.04f), ("decay", 0.4f), ("release", 0.45f), ("detune", 0.3f), ("panspread", 0.35f), ("humanize", 0.1f), ("volume", 0.8f));
        Inst("pendulum", 8, "Slow Swing",        ("balls", 0.25f), ("rate", 0.56f), ("sync", 0f), ("freerate", 0.9f), ("motion", 0.33f), ("quantize", 0f), ("spread", 0.2f), ("notelen", 0.8f), ("tone", 0.35f), ("attack", 0.35f), ("decay", 0.7f), ("release", 0.8f), ("detune", 0.4f), ("bright", 0.3f), ("panspread", 0.5f), ("humanize", 0.25f), ("volume", 0.82f));
        ...
        // ---- Nota Rhythm (kind 12): no presets of its own — its kits are the factory drum kits
        //      (KitCatalog), shared with the Drum Rack and loaded by the kit picker / browser.
